...
export const DEFAULT_LEARNED_LAYOUTS: LearnedLayoutPattern[] = [
  ...
  },
  {
    ...
    bankCode: '237',
    bankName: 'Banco Bradesco S.A.',
    issuerName: 'FIDC COMPLEMENTAR AUTO FORD',
    layoutName: 'Boleto Bradesco - FIDC Complementar Auto Ford / Granvia Veículos (237)',
    confidenceScore: 0.99,
    timesUsed: 220,
    successCount: 220,
    avgExtractionTimeMs: 11,
    ...
    anchors: {
      ...
      valorAnchor: 'Valor Documento',
      vencimentoAnchor: 'Data de Vencimento',
      beneficiarioAnchor: 'FIDC COMPLEMENTAR AUTO FORD',
      seuNumeroAnchor: 'Número do Documento',
      nossoNumeroAnchor: 'Nosso Número',
    },
    keywords: [
      'fidc complementar auto ford',
      'fidc auto ford',
      'ford',
      'granvia veiculos s/a',
      'granvia veiculos',
      '043.489.824/0001-80',
      '043489824000180',
      '012.946.886/0001-40',
  ...
  {
    id: 'layout-santander-fidc-veiculos-renault-12a',
